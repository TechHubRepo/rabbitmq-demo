...
public class SpringConfiguration {
	...
	public Exchange myExchange1() {
		return ExchangeBuilder.headersExchange(Constant.EXCHANGE_NAME).build();
	}
	 ...
	 */
	@Bean
	public Binding myBinding1(Queue myQueue1, HeadersExchange myExchange1) {
		return BindingBuilder.bind(myQueue1).to(myExchange1).where(Constant.HEADERS_NAME_1).matches(Constant.HEADERS_NAME_1_VAL); 
	}
	 ...
	 */
	@Bean
	public Binding myBinding2(Queue myQueue2, HeadersExchange myExchange1) {
		return BindingBuilder.bind(myQueue2).to(myExchange1).where(Constant.HEADERS_NAME_2).matches(Constant.HEADERS_NAME_2_VAL); 
	}
	 ...
	 */
	@Bean
	public Binding myBinding3(Queue myQueue3, HeadersExchange myExchange1) {
		return BindingBuilder.bind(myQueue3).to(myExchange1).where(Constant.HEADERS_NAME_3).matches(Constant.HEADERS_NAME_3_VAL); 
	}
}
